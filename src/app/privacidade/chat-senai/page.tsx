          ...
          <Card>
            ...
            <CardContent className="space-y-4 text-justify">
              ...
              <p className="text-muted-foreground">
                ...
                plataforma de software como serviço &quot;Chat IA SENAI-PI&quot; (&quot;
                ...
                ou
                <strong> “SENAI-PI</strong>&quot; ou{" "}
                <strong>&quot;Empresa Cliente&quot; ou “Licenciada”</strong>).
              </p>
              <p className="text-muted-foreground">
                Esta Política se aplica exclusivamente à Plataforma &quot;Chat IA SENAI-PI&quot; e a
              ...
              <p className="text-muted-foreground">
                ...
                Chat IA SENAI-PI e Termo de Serviço, Licenciamento de Software como Serviço (SaaS) e
          ...
          <Card>
            ...
            <CardContent className="space-y-4 text-justify">
              <p className="text-muted-foreground">
                ...
                (SENAI-PI), na qualidade de Controladora exclusiva e empregadora dos Usuários
                Finais, detém o direito pleno e irrestrito de acessar, monitorar, revisar, reter e
                analisar todos e quaisquer Dados Pessoais e Conteúdo das Interações gerados por seus
                usuários na Plataforma, a qualquer momento e sem a necessidade de notificação prévia
                ou consentimento específico do usuário individual.
              </p>
              <p className="text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent className="space-y-4 text-justify">
              ...
              <div className="space-y-2">
                ...
                <ul className="ml-6 list-inside list-disc space-y-2 text-muted-foreground">
                  <li>
                    Fornecer, operar, manter e otimizar a Plataforma &quot;Chat IA SENAI-PI&quot;;
                  </li>
          ...
          <Card>
            ...
            <CardContent className="space-y-4 text-justify">
              ...
              <p className="text-muted-foreground">
                ...
                LICENCIADA (SENAI-PI), através dos canais por ela definidos. A LICENCIANTE não terá
              ...
              <p className="text-muted-foreground">
                ...
                <strong>SENAI-PI</strong> e à Autoridade Nacional de Proteção de Dados (ANPD),

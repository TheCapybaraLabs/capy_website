...
const faqItems = [
  {
    ...
    answer: (
      <p className="text-muted-foreground">
        O Chat IA SENAI-PI é uma plataforma corporativa de IA que apoia os colaboradores em tarefas
  ...
  },
  {
    ...
    answer: (
      <p className="text-muted-foreground">
        Abra o Chat IA SENAI-PI, digite o que você precisa na caixa de mensagem e envie. Selecione
  ...
  },
  {
    ...
    answer: (
      <div>
        ...
        <Image
          src="/faq-choose-model-SENAI.gif"
  ...
  },
  {
    ...
    answer: (
      <ul className="list-inside list-disc space-y-2 text-muted-foreground">
        ...
        <li>
          Faça perguntas de acompanhamento (o Chat IA SENAI-PI lembra o contexto dentro de um chat).
        </li>
        <li>
  ...
  },
  {
    ...
    answer: (
      <p className="text-muted-foreground">
        O acesso ao Chat IA SENAI-PI é definido pela organização. Alguns perfis podem contar com
        ...
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <h1 className="font-bold text-4xl tracking-tight">
              Chat IA SENAI-PI: Perguntas frequentes
            </h1>
            ...
            <p className="text-muted-foreground">
              ...
              controlar seus dados e sua privacidade no Chat IA SENAI-PI.
            </p>
          </div>

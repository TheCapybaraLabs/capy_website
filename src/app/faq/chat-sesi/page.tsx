...
const faqItems = [
  {
    ...
    answer: (
      <p className="text-muted-foreground">
        O Chat IA SESI-PI é uma plataforma corporativa de IA que apoia os colaboradores em tarefas do dia a dia, como
  ...
  },
  {
    ...
    answer: (
      <ul className="space-y-2 text-muted-foreground list-disc list-inside">
        ...
        <li>Faça perguntas de acompanhamento (o Chat IA SESI-PI lembra o contexto dentro de um chat).</li>
  ...
  },
  {
    ...
    answer: (
      <p className="text-muted-foreground">
        O acesso ao Chat IA SESI-PI é definido pela organização. Alguns perfis podem contar com recursos adicionais,
  ...
  },
  {
    ...
    answer: (
      <p className="text-muted-foreground">
        Consulte a{' '}
        <a href="/privacidade/chat-sesi" target="_blank" className="text-primary underline hover:text-primary/80">
          Política de Privacidade
        </a>{' '}
        e os{' '}
        <a href="/termos/chat-sesi" target="_blank" className="text-primary underline hover:text-primary/80">
          Termos de Uso
        </a>{' '}
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <h1 className="text-4xl font-bold tracking-tight">Chat IA SESI-PI: Perguntas frequentes</h1>
            ...
            <p className="text-muted-foreground">
              ...
              e sua privacidade no Chat IA SESI-PI.
            </p>
          </div>

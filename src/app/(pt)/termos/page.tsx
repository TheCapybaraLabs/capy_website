      ...
      <section className="bg-muted/50 py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="space-y-4 text-center">
            ...
            <h1 className="font-bold text-4xl md:text-5xl">Termos de Serviço</h1>
          ...
          <div className="space-y-8">
            <Card>
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <p>
                  Ao acessar e utilizar os serviços da Capybara Labs, você concorda em ficar
                  vinculado a estes Termos de Serviço. Se você não concordar com qualquer parte
            ...
            <Card>
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <p>
                  Todo conteúdo, software, código e materiais fornecidos pela Capybara Labs são
                  protegidos por direitos autorais e outras leis de propriedade intelectual.
                </p>
                <p>
                  Para projetos customizados, os termos de propriedade intelectual serão definidos
            ...
            <Card>
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <p>
                  A Capybara Labs se compromete a manter a confidencialidade de todas as informações
            ...
            <Card>
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <p>
                  A Capybara Labs não será responsável por danos indiretos, incidentais, especiais
            ...
            <Card>
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <p>
                  A Capybara Labs reserva-se o direito de modificar estes termos a qualquer momento.
                  Notificaremos os clientes sobre mudanças significativas por e-mail ou através de
                  nosso site.
                </p>
              </CardContent>
            </Card>

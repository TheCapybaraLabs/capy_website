...
export function FaqTemplate({ client }: Props) {
  const faqItems = [
    {
      value: "o-que-e",
      question: `O que é o ${client.name}?`,
      answer: (
        <p className="text-muted-foreground">
          O {client.name} é uma plataforma corporativa de IA que apoia os colaboradores em tarefas
    ...
    {
      value: "onde-usar",
      question: `Onde posso usar o ${client.name}?`,
      answer: (
    ...
    },
    {
      ...
      answer: (
        <p className="text-muted-foreground">
          Abra o {client.name}, digite o que você precisa na caixa de mensagem e envie. Selecione
    ...
    },
    {
      ...
      answer: (
        <ul className="list-inside list-disc space-y-2 text-muted-foreground">
          ...
          <li>
            Faça perguntas de acompanhamento (o {client.name} lembra o contexto dentro de um chat).
          </li>
          <li>
            Envie um arquivo ou imagem para analisar, resumir ou transformar, quando o recurso
            estiver habilitado.
          </li>
        </ul>
      ),
    ...
    {
      value: "pesquisa-web",
      question: `O ${client.name} consegue pesquisar na web?`,
      answer: (
        <p className="text-muted-foreground">
          Sim. Os modelos disponíveis podem acessar informações atualizadas por meio de pesquisas na
          internet, permitindo a consulta a conteúdos recentes, dados públicos e fontes confiáveis.
          Ao formular sua pergunta no chat, informe se deseja que a resposta inclua pesquisa externa
          e referências, para que o sistema realize a busca e apresente as fontes utilizadas.
        </p>
      ),
    },
    {
      ...
      answer: (
        <div>
          <p className="text-muted-foreground">
            Chats temporários não aparecem no histórico, não usam/criam memórias e não são usados
            para treinar modelos. Quando quiser mais privacidade para uma conversa específica,
            inicie um chat temporário no ícone localizado no canto superior direito da tela inicial.
          </p>
    ...
    },
    {
      ...
      answer: (
        <div className="space-y-3 text-muted-foreground">
          ...
          <p>
            Para excluir a conta, verifique <strong>Configurações → Conta</strong> (quando
            disponível) ou solicite ao suporte institucional. A exclusão é permanente e segue os
            prazos padrão.
          </p>
        </div>
      ),
    },
    {
      ...
      answer: (
        <p className="text-muted-foreground">
          O acesso ao {client.name} é definido pela organização. Alguns perfis podem contar com
          recursos adicionais, limites maiores ou integrações específicas. Consulte a área
          responsável pelo serviço para detalhes.
        </p>
      ),
    },
    {
    ...
    },
    {
      ...
      answer: (
        <p className="text-muted-foreground">
          Sim, quando disponível. Use "Compartilhar" para criar um link para uma cópia somente
          leitura e envie para outras pessoas, respeitando as políticas internas. Os links podem ser
          gerenciados em{" "}
    ...
    },
    {
      ...
      answer: (
        <p className="text-muted-foreground">
          ...
          {client.name} para obter detalhes sobre dados, segurança e uso aceitável.
        </p>
      ),
    },
    {
        ...
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <h1 className="font-bold text-4xl tracking-tight">
              {client.name}: Perguntas frequentes
            </h1>
            <p className="text-muted-foreground text-sm">
              Última atualização: {client.lastUpdatedFaq}.
            </p>
            <p className="text-muted-foreground">
              Boas-vindas! Este FAQ apresenta o básico: como começar, o que você pode fazer e como
              controlar seus dados e sua privacidade no {client.name}.
            </p>
          </div>
